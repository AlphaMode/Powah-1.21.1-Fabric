...
public class EnergizingRodRenderer extends AbstractTileRenderer<EnergizingRodTile> {
    ...
    private void pos(VertexConsumer builder, PoseStack.Pose last, float x, float y, float z, int r, int g, int b, float u, float v) {
        builder.addVertex(last, x, y, z).setUv(u, v).setColor(r, g, b, 255).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880 / 2)

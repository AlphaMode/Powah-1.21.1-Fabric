...
public class Tank extends FluidTank {
    ...
    public FluidTank readFromNBT(HolderLookup.Provider registries, CompoundTag nbt, String key) {
        return super.readFromNBT(registries, nbt.getCompound(key));
    }

    public CompoundTag writeToNBT(HolderLookup.Provider registries, CompoundTag nbt, String key) {
        CompoundTag compound = super.writeToNBT(registries, new CompoundTag());
